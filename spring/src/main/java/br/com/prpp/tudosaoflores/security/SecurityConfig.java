    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/pedidos/reservas/solicitadas").hasAnyRole("GERENTE", "ATENDENTE", "SUPER_ADMIN")
                .requestMatchers(HttpMethod.PUT, "/pedidos/reserva/{idPedido}/confirmar").hasAnyRole("GERENTE", "ATENDENTE", "SUPER_ADMIN")
                .requestMatchers(HttpMethod.PUT, "/pedidos/reserva/{idPedido}/recusar").hasAnyRole("GERENTE", "ATENDENTE", "SUPER_ADMIN")
