          ...
          <>
            <div>
              ...
              <input
                ...
                onChange={onChange}
                className="w-full p-2 rounded-lg border border-rosa-pastel bg-white focus:ring-2 focus:ring-rosa-choque outline-none"
              />
            </div>
            <div>
              <label className="block text-sm font-bold text-rosa-choque mb-1">
        ...
        return (
          <>
            ...
            <div className="col-span-2">
              ...
              <select
                name="processoSecagem"
                value={formData.processoSecagem}
                onChange={onChange}
                className="w-full p-2 rounded-lg border border-rosa-pastel bg-white focus:ring-2 focus:ring-rosa-choque outline-none"
              >
                <option value="">Selecione...</option>
                ...
                <option value="PRESERVADA_GLICERINA">
                  Preservada Glicerina
                </option>
              </select>
            </div>
          </>
        ...
        return (
          <div className="col-span-2">
            ...
            <input
              type="text"
              name="tema"
              placeholder="Ex: Cesta de Café da Manhã, Dia dos Namorados..."
              value={formData.tema || ""}
              onChange={onChange}
              className="w-full p-2 rounded-lg border border-rosa-pastel bg-white focus:ring-2 focus:ring-rosa-choque outline-none"
            />
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              value={formData.nome}
              onChange={onChange}
              className="w-full p-3 rounded-xl border border-rosa-pastel bg-rosa-claro/20 focus:ring-2 focus:ring-rosa-choque outline-none"
            ...
            <div className="flex gap-4">
              ...
              <div className="w-32 h-32 rounded-xl overflow-hidden bg-rosa-claro border border-rosa-pastel flex-shrink-0 flex items-center justify-center">
                {formData.imagem ? (
                  ...
                  <span className="text-xs text-rosa-text/50 text-center p-2">
                    Nenhuma selecionada
                  </span>
                )}
              </div>
        ...
        <div className="md:col-span-2 flex justify-end gap-3 mt-4 pt-4 border-t border-rosa-pastel">
          {editandoCodigo && (
            <button
              type="button"
              onClick={onCancelar}
              className="px-6 py-3 rounded-xl font-bold text-rosa-text bg-rosa-claro hover:bg-rosa-pastel transition-all"
            >
              Cancelar
            </button>
          )}
          <button
            type="submit"
            className="px-6 py-3 rounded-xl font-bold text-white bg-rosa-choque hover:bg-rosa-escuro transition-all"
          >
